...
function EnvironmentDataBox(props: { data: environment_ }) {
  return props.data !== undefined ? (
    <div>
      <h1>
        {props.data.type} - {props.data.value} {props.data.unit}
      </h1>
      <h2>
        {props.data.type2} - {props.data.value2} {props.data.unit2}
      </h2>
    </div>
  ) : (
  ...
  //                     <div>
  //                         <h1>{props.data.type} - {props.data.value} {props.data.unit}</h1>
  //                         <h2>{props.data.type2} - {props.data.value2} {props.data.unit2}</h2>
  //                     </div>
